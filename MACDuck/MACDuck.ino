...
byte slp = 12;                       // Sleep pin - puts motor drivers to sleep, keeps motors cool
int cyanSwitch = 14;                 // This, and all pin numbers, could be uint8_t if needed. Will never be negative, never > 255
int yelSwitch = 15;
int magSwitch = 16;
int buttonCyan = 17;
bool modInit = false;
